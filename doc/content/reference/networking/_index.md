...
| LoRa Basic Station LNS | Web Sockets | Auth Token, Custom | 1887 | 8887 |

### Enterprise-only Ports

The following table lists the default ports for listeners available only in enterprise deployments.
